export const about1 = [
  {
    title: 'What is KLEF Chitramela?',
    description: 'A 48-hour film festival for aspiring filmmakers.',
    fullContent: 'KL University is home to over 10,000 students who excel in a wide range of careers and academic disciplines. Renowned not only for its education but also for its exceptional support system, KL University has consistently witnessed its students making remarkable contributions to the world of fine arts through innovative thinking and thought-provoking ideas. Fueled by boundless enthusiasm, the university\'s film club, "KL Film Technology Club," has teamed up with the university\'s administration to bring you the "KL Chitramela," a 24-hour film festival. This festival is a unique platform where aspiring filmmakers can learn and explore their craft. It offers students who are passionate about filmmaking the opportunity to showcase their talents through various filmmaking competitions.',
  },
  {
    title: 'Why KLEF Chitramela?',
    description: 'To showcase emerging filmmakers on a global scale.',
    fullContent: 'Universities serve as the birthplace of many aspiring filmmakers, where they discover their passion for the art of filmmaking. However, numerous budding filmmakers often find themselves compromising their dreams due to various challenging circumstances. The International Chitramela is dedicated to showcasing the skills and talents of these passionate and emerging filmmakers on a global scale. This 24-hour film festival provides a unique platform for budding filmmakers to connect and learn from their peers from around the world. It is our hope that this international event will inspire and rejuvenate the spirits of these talented individuals, encouraging them to persevere in the field of filmmaking.',
  }
]
export const about2 = [
  {
    title: 'About KLEF SAC Film Technology',
  ...
  {
    title: 'Who\'s Organising KLEF Chitramela',
